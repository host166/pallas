...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Switch_vue__ = __webpack_require__(8);
...
// module
exports.push([module.i, ".xg-switch[data-v-57f279ed]{display:inline-block;position:relative;width:44px;height:24px;border-radius:24px;line-height:22px;vertical-align:middle;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border:1px solid #eee;background-color:#eee}.xg-switch[data-v-57f279ed]:after{content:\"\";width:20px;border-radius:50%;background-color:#fff;position:absolute;left:1px;bottom:1px;top:1px;cursor:pointer;transition:margin-left .2s ease-in-out}.switch-large[data-v-57f279ed]{width:48px;height:28px;line-height:26px}.switch-large[data-v-57f279ed]:after{width:24px}.switch-small[data-v-57f279ed]{width:40px;height:20px;line-height:18px}.switch-small[data-v-57f279ed]:after{width:16px}.switch-disabled[data-v-57f279ed]:after{background-color:#ccc;border-color:#aaa;cursor:not-allowed}.switch-on[data-v-57f279ed]{position:absolute;font-size:12px;color:#fff;right:6px}.switch-on[data-v-57f279ed]:after{margin-left:20px}.switch-off[data-v-57f279ed]{position:absolute;font-size:12px;color:#fff;right:6px}", ""]);
...
var update = __webpack_require__(12)("995da656", content, true);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?minimize!../../../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-57f279ed\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Switch.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?minimize!../../../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-57f279ed\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Switch.vue");
